DROP TABLE IF EXISTS ADJUSTMENT1;
CREATE TABLE IF NOT EXISTS ADJUSTMENT1(BILL_ENT_ID BIGINT NOT NULL,
...
deploy package MSSQL 'com.microsoft.sqlserver:sqljdbc4:4.0' repos 'https://clojars.org/repo/' path ':homeDirLocation/work/sqljdbcJar';